...
def load_backbone(name, output_attentions=False):
    ...
    if name == 'bert':
        ...
        backbone = BertModel.from_pretrained(pretrain_path, output_attentions=output_attentions)
        tokenizer = BertTokenizer.from_pretrained(pretrain_path)
        tokenizer.name = 'bert-base-chinese'

    elif name == 'roberta':
        pretrain_path = 'pretrain_model/chinese_roberta_wwm_ext'
        from transformers import BertModel, BertTokenizer
        backbone = BertModel.from_pretrained(pretrain_path, output_attentions=output_attentions)
        tokenizer = BertTokenizer.from_pretrained(pretrain_path)
        tokenizer.name = 'chinese-roberta-wwm-ext'
